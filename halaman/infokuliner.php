...
<?php $fetch = mysqli_query($koneksi,"SELECT * FROM wisata_kuliner WHERE id = '$_GET[id]';"); ?>
<html lang="en">
<head>
...
<!-- Navbar -->
	...
	<nav>
		...
		?>
		<div class="card" id="../halaman/infokuliner.php?hal=info&id=<?php echo $data['id'] ?>">
	...
	<nav>
		<div class="card" id="../halaman/infokuliner.php?hal=info&id=<?php echo $data['id'] ?>">
			<div class="center" align="center">
				<h1>Tempat Penjual <?php echo $data['nama'] ?></h1>
