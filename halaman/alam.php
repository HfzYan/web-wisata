 	...
 	<nav>
 		<a href="../index.php">
			<img src="../img/logoamazingkalsel.png" alt="logo">
				<ul>
					<li><a href="alam.php?page=alam" class="active">ALAM</a></li>
...
<div class="container">
    ...
    <div class="box-container">
		...
		<div class="box">
            <a style="text-decoration:none" href="../halaman/infoalam.php?hal=info&id=<?php echo $data['id'] ?>" ><img src="<?php echo $data['gambar'] ?>" alt="">
